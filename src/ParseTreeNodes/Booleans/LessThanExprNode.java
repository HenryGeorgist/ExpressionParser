 ...
 */
public class LessThanExprNode extends ParseTreeNodes.BinaryExprNode{
    public LessThanExprNode(ParseTreeNodes.ParseTreeNode left, ParseTreeNodes.ParseTreeNode right) {
        super(left, right);
    }
    @Override
    ...
    public ParseTreeNodes.Tokens Token() {
        return ParseTreeNodes.Tokens.LT;
    }
    @Override
