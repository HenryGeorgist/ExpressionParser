 ...
 */
public class LessThanOrEqualExprNode extends ParseTreeNodes.BinaryExprNode{
    public LessThanOrEqualExprNode(ParseTreeNodes.ParseTreeNode left, ParseTreeNodes.ParseTreeNode right) {
        super(left, right);
    }
    @Override
    ...
    public ParseTreeNodes.Tokens Token() {
        return ParseTreeNodes.Tokens.LTE;
    }
    @Override
