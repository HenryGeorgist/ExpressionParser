 ...
 */
public class GreaterThanExprNode extends ParseTreeNodes.BinaryExprNode{
    public GreaterThanExprNode(ParseTreeNodes.ParseTreeNode left, ParseTreeNodes.ParseTreeNode right) {
        super(left, right);
    }
    @Override
    ...
    public ParseTreeNodes.Tokens Token() {
        return ParseTreeNodes.Tokens.GT;
    }
    @Override
